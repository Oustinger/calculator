...
import calcOperations, { CalcOperationsInterface } from '../../calculatorFunctional/operations/calculateOperations/calcOperations';
import defaultOperations, { DefaultOperationsInterface } from '../../calculatorFunctional/operations/defaultOperations/defaultOperations';
import numbersInputs, { NumbersInputsInterface } from '../../calculatorFunctional/operations/numbersInputs/numbersInputs';
import parenthesesOperations, { ParenthesesInterface } from '../../calculatorFunctional/operations/parentheses/parentheses';
...
export const calcSlice = createSlice({
    ...
    reducers: {
        ...
        addSymbolAction: (state, action: MyPayloadAction) => (
            { ...state, input: `${state.input}${action.payload ? action.payload.symbol : ''}` }
        ),
